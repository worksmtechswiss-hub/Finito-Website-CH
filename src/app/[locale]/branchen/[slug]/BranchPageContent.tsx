  ...
  return (
    <>
      ...
      <section className="relative py-24 lg:py-32 hero-gradient overflow-hidden">
        ...
        <div className="absolute top-1/4 -right-20 w-80 h-80 bg-accent-400/10 rounded-full blur-[100px] animate-glow-pulse" />
      ...
      <section className="relative py-24 hero-gradient overflow-hidden">
        ...
        <div className="absolute bottom-1/4 -right-20 w-80 h-80 bg-accent-400/10 rounded-full blur-[100px] animate-glow-pulse" />
